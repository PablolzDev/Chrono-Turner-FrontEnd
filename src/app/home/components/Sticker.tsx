  ...
  <div className={styles.sticker}>
    <div className={styles.content}>
      <div className={styles.panel}>
        <div className={styles.panelRow}>
          <div className={styles.card}>
            <div className={styles.cardColumn}>
              <div className={styles.cardAvatar}> <img src="https://cloudflare-ipfs.com/ipfs/Qmd3W5DuhgHirLHGVixi6V76LhCkZUz6pnFt5AJBiyvHye/avatar/526.jpg" alt=""
                />
              </div>
            </div>
        ...
        {/* Add more panel rows and cards as needed */}
        <div className={styles.panelRow}>
          <div className={styles.card}>
            <div className={styles.cardColumn}>
